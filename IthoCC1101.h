...
//message 2 commands decoded
const uint8_t ithoMessage2DecPowerCommandBytes[] =   {34,241,3,0,4,4};
const uint8_t ithoMessage2RVHighCommandBytes[] =     {49,224,4,0,0,200};
const uint8_t ithoMessage2DecHighCommandBytes[] =    {34,241,3,0,4,4};
const uint8_t ithoMessage2DecMediumCommandBytes[] =  {34,241,3,0,3,4};
const uint8_t ithoMessage2RVMediumCommandBytes[] =   {34,241,3,0,3,7};
const uint8_t ithoMessage2DecLowCommandBytes[] =     {34,241,3,0,2,4};
const uint8_t ithoMessage2RVLowCommandBytes[] =      {49,224,4,0,0,1};
const uint8_t ithoMessage2RVAutoCommandBytes[] =     {34,241,3,0,5,7};
const uint8_t ithoMessage2DecStandByCommandBytes[] = {0,0,0,0,0,0};         //unkown
const uint8_t ithoMessage2DecTimer1CommandBytes[] =  {34,243,3,0,0,10};     //10 minutes full speed
const uint8_t ithoMessage2DecTimer2CommandBytes[] =  {34,243,3,0,0,20};     //20 minutes full speed
const uint8_t ithoMessage2DecTimer3CommandBytes[] =  {34,243,3,0,0,30};     //30 minutes full speed
const uint8_t ithoMessage2DecJoinCommandBytes[] =    {31,201,12,0,34,241};
const uint8_t ithoMessage2DecJoin2CommandBytes[] =   {0,0,0,0,0,0};         //join command of RFT AUTO Co2 remote
const uint8_t ithoMessage2RVJoinCommandBytes[] =     {31,201,24,0,49,224};  //join command of RFT-RV?
const uint8_t ithoMessage2DecLeaveCommandBytes[] =   {31,201,6,0,31,201};
//itho rft-rv
//unknown, high
...
class IthoCC1101 : protected CC1101
{
    ...
    void message2Decode(CC1101Packet *packet, IthoPacket *itho);
